	...
	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="width:100%;object-fit: cover;overflow:hidden; user-select: none;">
	  ...
	  <div class="carousel-inner">
	    ...
	    <div class="carousel-item">
	     ...
	     <div class="carousel-item">
	      <img class="d-block w-100" style="cursor: pointer;" src="image/banner/메인4.png" alt="네번째 슬라이드" onclick="location.href='projectDetail.do?seq=165'">
	    </div>
	    <div class="carousel-item">
	      <img class="d-block w-100" style="cursor: pointer;" src="image/banner/메인5.png" alt="다섯번째 슬라이드" onclick="location.href='projectDetail.do?seq=166'">
	    </div>
	    <div class="carousel-item">
	      <img class="d-block w-100" style="cursor: pointer;" src="image/banner/메인6.png" alt="여섯번째 슬라이드" onclick="location.href='projectDetail.do?seq=167'">
	    </div>
	  </div>
